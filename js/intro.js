...
M.mod_gallery.moveIntro = function(direction,gallery) {
    var scroll = M.mod_gallery.Y.one('#mod-gallery-intro-thumb-cont-helper-'+gallery).get('scrollX');
    var scrollS = M.mod_gallery.Y.one('#mod-gallery-intro-thumb-cont-helper-'+gallery).get('scrollY');
    if(direction === 'left') 
       scroll -= 154;
