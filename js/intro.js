...
M.mod_gallery.init = function(Y, cfg) {
    ...
    this.maxScroll = Y.one(".mod-gallery-intro-thumb-cont-helper > ul").get('winWidth') - Math.ceil(Y.one('.mod-gallery-intro-thumbnails-container').getComputedStyle('width'));    
};
